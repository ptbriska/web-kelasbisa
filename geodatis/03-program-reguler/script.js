 ...
 * Pure Fetcher for Program Reguler Showcase & Lightbox Preview Modal.
 */
...
async function fetchRegulerData() {
  try {
    ...
    console.error("GEODATIS Reguler Fetch Error:", err.message);
    return null;
  }
}
...
// 2. RENDER POSTER GRID HORIZONTAL
...
// 3. RENDER DAFTAR PROGRAM CARDS (2 KOLOM GRID)
